...
<!-- contact -->
			...
			<div class="col-md-4 contact-grids">
				<div class=" contact-grid animated wow fadeInLeft" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<div class="contact-grid3">
							<h4>Address</h4>
							<p>University of Nigeria,Nsukka<span>Enugu State Nigeria.</span></p>
						</div>
					</div>
				</div>
				<div class=" contact-grid animated wow fadeInUp" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<div class="contact-grid3">
							<h4>Call Us</h4>
							<p>08163922749<span>08108273445</span></p>
						</div>
					</div>
				</div>
				<div class=" contact-grid animated wow fadeInRight" data-wow-delay=".5s">
					<div class="contact-grid1">
						...
						<div class="contact-grid3">
							<h4>Email</h4>
							<p><a href="contactto:info@example.com">vivvaa.vivvaa@gmail.com</a><span><a href="contactto:info@example.com">vivvaa.vivvaa@yahoo.com</a></span></p>
						</div>
					</div>
				</div>
	...
	<div class="map">
		<iframe class="animated wow fadeInLeft" data-wow-delay=".5s" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d63383.27940818785!2d7.39336955!3d6.835928399999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sng!4v1463792008882" frameborder="0" style="border:0" allowfullscreen></iframe>
		</div >
<!-- //contact -->
<!-- footer -->
