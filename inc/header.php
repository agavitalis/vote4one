...
<!-- header -->
	<div class="header" id= "mainwork">
			...
			if(isset($fname)||isset($ahambu))
			
			{
			echo '<ul>
						<li><i class="glyphicon glyphicon-user" ></i>'.$fname.$ahambu.'</li>
...
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
		function hideURLbar(){ window.scrollTo(0,1); } </script>
						 ...
						 <div class="navbar-brand logo-nav-left wow fadeInLeft animated" data-wow-delay=".5s">
							<h1 class="animated wow pulse" data-wow-delay=".5s"><a href="../index.php">Vote<span id="m4">4<span>one</span></a></h1>
						</div>
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown active">
								<a href='#quickguide' data-toggle='modal' data-target='#quickguide'> Quick Guide </a>
							</li>
        	...
        	<div class='modal-content'>
				...
				<p><em>Note:</em><br>
					<ul type="i">
						...
						<li>5.Vote for one is commited to servig you better and will not hesitate to delete the account of any malicious Client</li>
