...
?>
 	<?php
     	...
     	// Form the SQL query that returns the total number of regitered contestants
		
		$strQuery = "SELECT * FROM contestants WHERE `electbody`='$ahaulo' AND`post`='President'";
		...
		//$row=mysql_fetch_array($Total);
     	...
     	$result = $dbhandle->query($strQuery) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
			$Totalcontestants = mysqli_num_rows($result);
     	// If the query returns a valid response, prepare the JSON string
     	if ($result) {
        	// The `$arrData` array holds the chart attributes and data
        	$arrData = array(
                "chart" => array(
                    "caption" => "Presidential Election Result",
	...
	// Push the data into the array
			...
			$v = $row["fname"];
			if($vita=mysqli_query( $dbhandle,"SELECT * FROM voting WHERE `electbody`='$ahaulo' AND `postVotedFor`='President' AND `candidateVoted`='$v'"))
 ...
 $totalVotecast = "SELECT * FROM voting WHERE `electbody`='$ahaulo' AND `postVotedFor`='President' ";
		...
		<div class="product">
			...
			<div class="categories animated wow fadeInUp animated" data-wow-delay=".5s" >
					...
					<ul class="cate">
						...
						<li class="list-group-item list-group-item-success"><i class="glyphicon glyphicon-menu-right" ></i><a href="jw/vpp.php">Vice-President</a></li>
						<li class="list-group-item list-group-item-success"><i class="glyphicon glyphicon-menu-right" ></i><a href="jw/sec.php">Secretery</a></li>
						<li class="list-group-item list-group-item-success"><i class="glyphicon glyphicon-menu-right" ></i><a href="jw/tre.php">Tresurer</a></li>
						<li class="list-group-item list-group-item-success"><i class="glyphicon glyphicon-menu-right" ></i><a href="jw/pro.php" >Provost</a></li>
						<li class="list-group-item list-group-item-success"><i class="glyphicon glyphicon-menu-right" ></i><a href="jw/dos.php">Director of Social</a></li>
						<li class="list-group-item list-group-item-success"><i class="glyphicon glyphicon-menu-right" ></i><a href="jw.dost.php">Director of Sports</a></li>
						<li class="list-group-item list-group-item-success"><i class="glyphicon glyphicon-menu-right" ></i><a href="jw/dot.php">Director of Transport</a></li>
						<li class="list-group-item list-group-item-success"><i class="glyphicon glyphicon-menu-right" ></i><a href="jw/dis.php">Disciplinarian</a></li>
...
<div class="col-md-9 animated wow fadeInRight" data-wow-delay=".5s"><!--//General div fades in rigbt-->	
				...
				<div class="mens-toolbar">
					<div class="colors animated wow fadeInUp animated" data-wow-delay=".5s" > 
					<h3 id= "msg"><?php if(!$vita){echo "NO RESULTS YET FOR THE PRESIDENT";}
					else{echo "PRESIDENTIAL ELECTIONS RESULTS"; }?>
					</div>
	    		    <div class="clearfix"></div>		
		        </div>
...
<div class="mid-popular">
  ...
  <div class="container" >
		...
		<div class="col-md-8 login-do animated wow fadeInCenter" id="chart-1"></div>  <!--for the graph-->
		
		<div class="col-md-8 login-do animated wow fadeInCenter">
		<!--for the result detalis-->
		<p><h3><center><u>Summary of the Presidential Elections</u></center></h3></br>
...
// Establish a connection to the database
  ...
  // Render an error message, to avoid abrupt failure, if the database connection parameters are incorrect
   if ($dbhandle->connect_error) {
	...
	$str = "SELECT * FROM contestants WHERE `electbody`='$ahaulo' AND`post`='President'";
		...
		while($rorr = mysqli_fetch_array($t)) {
			$f = $rorr["fname"];
			$l = $rorr["lname"];
			$diebere = mysqli_query( $dbhandle,"SELECT * FROM voting WHERE `electbody`='$ahaulo' AND `postVotedFor`='President' AND `candidateVoted`='$f'");
